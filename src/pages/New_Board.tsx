...
const New_Board = () => {
  ...
  return (
    <div className="flex-1 bg-[url('assets\new.jpg')] ">
      <Layout>
        {/* Formulaire */}
        <form
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <button
              type="submit"
              className="bg-primary text-primary-foreground hover:bg-primary/90 font-bold py-2 px-6 rounded focus:outline-none focus:shadow-outline transition-transform transform hover:scale-105"
            >
              Create
            </button>
            <button
